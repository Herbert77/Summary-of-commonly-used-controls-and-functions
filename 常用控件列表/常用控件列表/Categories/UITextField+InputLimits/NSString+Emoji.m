...
- (BOOL)isEmojiUnicode
{
    ...
    NSInteger res = [regex numberOfMatchesInString:str options:kNilOptions range:NSMakeRange(0, str.length)];
    //    NSLog(@"%zd", res);
    if (res == 0) {
        return NO;
    }
...
- (NSString *)disable_emoji {
    ...
    //    NSString *emojiReg = @"[^\\u0020-\\u007E\\u00A0-\\u00BE\\u2E80-\\uA4CF\\uF900-\\uFAFF\\uFE30-\\uFE4F\\uFF00-\\uFFEF\\u0080-\\u009F\\u2000-\\u201f\r\n]";
    NSString *emojiReg = @"[^\\u0021-\\u007E\\u00A0-\\u00BE\\u2E80-\\uA4CF\\uF900-\\uFAFF\\uFE30-\\uFE4F\\uFF00-\\uFFEF\\u0080-\\u009F\\u2000-\\u201f\\r\\n\\u2026]";
    NSRegularExpression *regex = [NSRegularExpression regularExpressionWithPattern:emojiReg
