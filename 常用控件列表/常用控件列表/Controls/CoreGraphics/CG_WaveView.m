...
@implementation CG_WaveView

+ (instancetype)loadingView
{
    return [[CG_WaveView alloc] initWithFrame:CGRectMake(0, 0, 40, 31)];
}
...
- (void)setupSubViews
{
    ...
    self.waveSinLayer.fillColor = [[UIColor colorWithRed:0.58 green:0.85 blue:0.98 alpha:1.00] CGColor];
